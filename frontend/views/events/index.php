...
<section class="slice-lg slice--offset-top has-bg-cover bg-size-cover" style="background-image: url('./images/banners/eventos.png'); background-position: bottom center;">
