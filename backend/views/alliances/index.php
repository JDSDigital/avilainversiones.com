...
/* @var $searchModel common\models\AlliancesSearch */
...
<div class="card">
    <div class="card-header header-elements-inline">
        ...
        <div class="header-elements">
            <?= Html::a('Crear una alianza', ['create'], ['class' => 'btn btn-success']) ?>
        </div>
    </div>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    $check = ($model->status == Alliances::STATUS_ACTIVE) ? "checked='checked'" : null;
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model, $key) {
                        return Html::a('<span class="icon-trash" aria-hidden="true"></span>', ['delete', 'id' => $model->id], [
                            'data' => [
                                'confirm' => '¿Seguro desea borrar esta alianza?',
                                'method' => 'post',
                            ],
                        ]);
                    }
...
<?php
    $this->registerJs('listenerChangeStatus("'.Url::to(["alliances/status"]).'");');
?>
